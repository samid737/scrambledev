...
*These features where implemented in early 2017,  all details are not included.*
...
A simulated world is setup by adjusting the world size to some  large (but not infinite) size. Since combat aircraft fly below the  [stratosphere](http://www.online-sciences.com/wp-content/uploads/2014/09/stratosphere-layer-11.jpg),  the height of the world will be less than the height of the stratosphere [ Assumption](#). I still have to think about the best solution for the width of the world. It may be fixed, but could also vary with each mission.
